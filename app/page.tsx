...
const questions = [
  {
    question: "Как подготовиться к встрече и что взять с собой?",
    answer: (
      <>
        <span className="faq-answer-part">
          <strong>Длительность.</strong> Обычно встреча занимает около 3–3,5 часов.
        </span>
        <span className="faq-answer-part">
          <strong>С собой.</strong> Обязательно приходите в удобной одежде — во время практики мы много сидим на полу. По желанию можно взять свой коврик, бубен или шумелки, а также что-нибудь к чаю.
        </span>
        <span className="faq-answer-part">
          <strong>Важно.</strong> Лучше приходить немного заранее. Опоздание нарушает общий ритм, а через 15 минут после начала присоединиться к практике уже не получится. Пожалуйста, заранее рассчитайте время на дорогу и задайте все вопросы ведущему до начала встречи.
        </span>
      </>
    ),
  },
