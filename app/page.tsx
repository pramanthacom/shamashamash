  ...
  return (
    <main>
      ...
      <section className="roots section-paper" id="roots">
        ...
        <aside className="research-accent">
          <p className="method-kicker">Современный исследовательский контекст</p>
          <p>
            Сегодня это уже не только язык древней шаманской традиции. Современная
            форма метода описывается, изучается и преподаётся профильными институтами
            в США, Германии и России. Практика становится предметом наблюдения,
            сопоставления опыта и последовательного обучения.
          </p>
        </aside>
