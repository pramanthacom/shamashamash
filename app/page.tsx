    ...
    <main>
      ...
      <section className="value-screen section-paper" id="why">
        <div className="value-shell">
          ...
          <h2>Чтобы искать ответы, дать место накопившимся чувствам и увидеть свою жизнь иначе</h2>
          <p className="value-lead">
            Ритм, особая поза тела и направленное внимание помогают войти в изменённое
            состояние сознания. В нём можно заметить образы, чувства и связи, которые
            не возникают в обычном ходе размышлений.
          </p>
          ...
          <div className="value-return">
            <p>
              Не просто пережить необычное состояние — вернуться в повседневную жизнь
              с новым ощущением, вопросом или возможным следующим шагом.
            </p>
            <small>
              У каждого опыт складывается по-своему: он может быть ярким или тихим,
              понятным сразу или раскрыться позже. Практика не гарантирует ответ,
              изменение или иной определённый результат.
            </small>
          </div>
        </div>
      </section>
