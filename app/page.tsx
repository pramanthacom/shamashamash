...
const questions = [
  ...
  },
  {
    ...
    answer:
      "Не приходите в состоянии алкогольного или наркотического опьянения, острого психического кризиса, психотического или маниакального эпизода, выраженной дезориентации. При психиатрическом диагнозе, эпилепсии, судорожных состояниях, неврологическом заболевании или сомнениях в своём состоянии сначала обсудите участие с лечащим специалистом и ведущим. О физических ограничениях лучше сообщить заранее — для некоторых поз можно подобрать более комфортный вариант.",
  },
];
    ...
    <main>
      ...
      <section className="roots section-paper" id="roots">
        ...
        <div className="roots-grid">
          ...
          <article className="roots-modern">
            <span>Современная форма</span>
            <h3>Экстатический транс изучают и преподают</h3>
            <p>
              С 1960-х годов Фелиситас Гудман исследовала воздействие ритма и
              ритуальных поз на изменённые состояния сознания. Сегодня метод
              развивают и преподают профильные институты в США и Германии; в России
              он входит в обучающие программы ИТОП. Это структурированная практика
              экстатического транса для исследования разных состояний и возникающего в них опыта.
            </p>
            <p className="roots-evidence">
              <strong>Лабораторное наблюдение</strong>
              В раннем исследовании 1983 года с четырьмя добровольцами во время
              15-минутного погружения уровни кортизола, адреналина и норадреналина
              после начального подъёма снижались, а уровень бета-эндорфина повышался.
              Это небольшой ранний опыт, а не доказательство лечебного эффекта.
            </p>
          </article>
        </div>
      ...
      <section className="meaning section-paper">
        <div className="meaning-copy">
          ...
          <p className="meaning-note">
            Не обязательно объяснить всё сразу. Важнее заметить, что опыт меняет
            в вашем ощущении ситуации и что вы захотите взять с собой в жизнь.
          </p>
        </div>
        <figure className="meaning-visual">
          <img
            ...
            decoding="async"
          />
          <figcaption>Разные объяснения. Один личный опыт.</figcaption>
        </figure>
      </section>
      ...
      <section className="safety section-dark" id="safety">
        ...
        <div className="safety-heading">
          ...
          <div>
            <p>
              Мы знаем трансовые состояния по сновидениям, глубокой сосредоточенности
              и моментам, когда полностью поглощены происходящим. Здесь тело становится
              главным инструментом: ритм, ритуальная поза и намерение помогают войти
              в такое состояние осознанно и получить опыт за пределами привычного хода мыслей.
            </p>
            <p className="safety-lead">
              На языке шаманской традиции транс — биологическая дверь в иную,
              сакральную действительность.
            </p>
          </div>
        </div>
        ...
        <div className="safety-principles">
          <article>
            <span>01</span>
            <h3>Участие добровольно</h3>
            <p>В любой момент можно открыть глаза, изменить позу или остановиться. Ничего не нужно проходить «до конца».</p>
          </article>
          <article>
            <span>02</span>
            <h3>Личное остаётся личным</h3>
            <p>Запрос и переживание не нужно объяснять группе или обсуждать после встречи.</p>
          </article>
          <article>
            <span>03</span>
            <h3>Без готовых толкований</h3>
            <p>Ведущий не ставит диагнозов, не пугает и не объявляет увиденное единственно верной истиной.</p>
          </article>
        </div>

        <p className="safety-disclaimer">
          Это не терапия и не медицинская услуга. Практика не заменяет лечение,
