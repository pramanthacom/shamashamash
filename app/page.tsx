          ...
          <div className="guide-story">
            <section className="guide-story-section">
              ...
              <p>
                ...
                и духовными. Я изучал их, проверял на собственном опыте и наблюдал,
                как разные методы раскрываются в жизни людей. Важной частью этого
                пути стали экспедиции по сакральным местам планеты.
              </p>
            </section>

            <section className="guide-story-section">
              <h3>Почему экстатический транс</h3>
              <p>
                Он стал одной из моих любимых и наиболее практичных практик. Мне
                близко, что он даёт человеку непосредственный личный опыт и не
                требует заранее принимать определённую систему верований.
                Переживание можно понимать психологически, символически, духовно —
                или оставить без окончательного объяснения.
              </p>
            </section>
