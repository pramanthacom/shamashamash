      ...
      <section className="guide section-paper" id="guide">
        ...
        <div className="guide-copy">
          ...
          <p>
            ...
            подходов: психологическими, телесными, дыхательными, символическими и
            духовными. Я изучал их, проверял на собственном опыте и наблюдал, как
            разные методы раскрываются в жизни людей. Важной частью этого пути
            стали экспедиции по сакральным местам планеты.
          </p>
          <p>
            Экстатический транс стал одной из моих любимых и наиболее практичных
            практик. Мне близко, что он даёт человеку непосредственный личный опыт
            и не требует заранее принимать определённую систему верований.
            Переживание можно понимать психологически, символически, духовно — или
            оставить без окончательного объяснения.
          </p>
          <p>
            До этого около двадцати лет я работал в сфере предотвращения кризисов
            и управления рисками. Этот опыт научил меня сохранять спокойствие в
            сложных ситуациях, внимательно относиться к состоянию людей, уважать
            границы и заранее думать о безопасности.
          </p>
          <p>
            Сейчас я продолжаю обучение в Институте ценностно-ориентированной
            психологии Олега Гадецкого и изучаю метод экстатического транса в ИТОП
            имени Фелиситас Гудман. На встрече моя задача — понятно провести вас
            через все этапы практики и создать условия, в которых вы сможете
            получить собственный опыт без давления и навязанных трактовок.
          </p>
        </div>
      </section>
