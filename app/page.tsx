    ...
    <main>
      ...
      <section className="meaning section-paper">
        <div className="meaning-copy">
          ...
          <p>
            В путешествии могут возникать образы, ощущения, эмоции, воспоминания
            или чувство контакта с чем-то большим. Один и тот же опыт можно
            понимать на разных языках — и ни один из них не навязывается.
          </p>
        ...
        <figure className="meaning-visual">
          <img
            src="/meaning-layers.jpg"
            alt="Человек в сосредоточенной позе исследует внутренний опыт"
            loading="lazy"
            decoding="async"
          />
      ...
      <section className="safety section-dark" id="safety">
        ...
        <div className="safety-heading">
          <h2>Без испытаний на смелость и преодоления себя</h2>
          <div>
            <p>
              Трансовое погружение требует внимания к своему состоянию, но не
              требует терпеть дискомфорт. Ваши границы важнее продолжения практики.
            </p>
            <p className="safety-lead">
              В любой момент можно открыть глаза, изменить позу или остановиться.
            </p>
          </div>
        </div>
        ...
        <div className="safety-principles">
          <article>
            ...
            <p>Не нужно доказывать, что вы способны пройти погружение до конца.</p>
          </article>
          <article>
            <span>02</span>
        ...
        <div className="safety-boundary">
          <div>
            <p className="method-kicker">Когда лучше не участвовать</p>
            <h3>Для группового погружения нужно устойчивое состояние</h3>
          </div>
          <div>
            <p>
              Не приходите в состоянии алкогольного или наркотического опьянения,
              острого психического кризиса, психотического или маниакального эпизода,
              выраженной дезориентации.
            </p>
            <p>
              Если у вас есть психиатрический диагноз, эпилепсия, судорожные состояния
              или неврологическое заболевание, вы проходите психотерапию либо сомневаетесь
              в своём состоянии — сначала обсудите участие с лечащим специалистом и ведущим.
            </p>
            <p>
              О физических ограничениях лучше сказать заранее: для некоторых поз
