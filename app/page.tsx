...
export default function Home() {
  return (
    <main>
      ...
      <section className="value-screen section-paper" id="why">
        <div className="value-shell">
          <p className="section-index">01 / Зачем это</p>
          <h2>Чтобы получить ответ, освободить накопившееся и увидеть свою жизнь иначе</h2>
          <p className="value-lead">
            Ритм, особая поза тела и направленное внимание помогают войти в состояние,
            где привычная логика отступает, а переживание может стать проясняющим,
            освобождающим, наполняющим или духовным.
          </p>

          <ul className="value-list" aria-label="Что может дать трансовое путешествие">
            <li>Расслабиться, отдохнуть и восстановить силы</li>
            <li>Дать выход накопившимся чувствам и напряжению</li>
            <li>Получить ответ или новый взгляд на важный вопрос</li>
            <li>Найти опору в переменах и почувствовать направление</li>
            <li>Соприкоснуться с образами, внутренними ресурсами и духовным опытом</li>
            <li>Ощутить больше целостности, энергии и связи с жизнью</li>
          </ul>

          <div className="value-return">
            <p>
              Не просто пережить что-то необычное — вернуться в повседневную жизнь
              с новым ощущением, взглядом или следующим шагом.
            </p>
            <small>
              Опыт может прийти как ясное понимание, образ, чувство или внутренний сдвиг.
              Иногда его значение раскрывается позже. Определённый результат не гарантируется.
            </small>
          </div>
        </div>
      </section>
