      ...
      <section className="safety section-light safety-cool" id="safety">
        ...
        <div className="safety-principles">
          <article>
            ...
            <p>В любой момент открыть глаза, изменить позу или завершить погружение.</p>
          </article>
          <article>
            <span>02</span>
            <h3>Можно не делиться</h3>
            <p>Запрос и переживание могут остаться только вашими.</p>
          </article>
          <article>
            <span>03</span>
            <h3>Без готовых толкований</h3>
            <p>Никаких диагнозов, запугивания и единственно верных трактовок.</p>
          </article>
        </div>
